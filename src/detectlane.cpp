...
DetectLane::DetectLane() {
    ...
    cvCreateTrackbar("LowH Shadow", "Threshold", &minShadowTh[0], 255);
    cvCreateTrackbar("HighH Shadow", "Threshold", &maxShadowTh[0], 255);
    cvCreateTrackbar("LowS Shadow", "Threshold", &minShadowTh[1], 255);
    cvCreateTrackbar("HighS Shadow", "Threshold", &maxShadowTh[1], 255);
    cvCreateTrackbar("LowV Shadow", "Threshold", &minShadowTh[2], 255);
    cvCreateTrackbar("HighV Shadow", "Threshold", &maxShadowTh[2], 255);

    // cvCreateTrackbar("LowH LandInShadow", "Threshold", &minLaneInShadow[0], 255);
    // cvCreateTrackbar("HighH LandInShadow", "Threshold", &maxLaneInShadow[0], 255);
    // cvCreateTrackbar("LowS LandInShadow", "Threshold", &minLaneInShadow[1], 255);
    // cvCreateTrackbar("HighS LandInShadow", "Threshold", &maxLaneInShadow[1], 255);
    // cvCreateTrackbar("LowV LandInShadow", "Threshold", &minLaneInShadow[2], 255);
    // cvCreateTrackbar("HighV LandInShadow", "Threshold", &maxLaneInShadow[2], 255);

    cvCreateTrackbar("SkyLine", "Threshold", &skyLine, 240);
...
{
    Mat imgThresholded, imgHSV, birdView;
    Mat imgOut, imgThresholdedShadow;
    ...
    imgThresholdedShadow = laneInShadow(src);
    bitwise_or(imgThresholded, imgThresholdedShadow, imgOut);

    birdView = birdViewTranform(imgOut);

    // imshow("Bird View", birdView);

    fillLane(birdView);
#ifdef _DEBUG
    imshow("Binary", imgOut);
#endif
    return birdView;
}
